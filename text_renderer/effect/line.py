...
class Line(Effect):
    ...
    def apply_right(self, img: PILImage, text_bbox: BBox) -> Tuple[PILImage, BBox]:
        ...
        right_top = (x_right_top, y_right_top - 20)
        right_bottom = (x_right_bottom, y_right_bottom + 20)
        draw.line(
    ...
    def apply_left(self, img: PILImage, text_bbox: BBox) -> Tuple[PILImage, BBox]:
        ...
        left_top = (x_left_top, y_left_top - 20)
        left_bottom = (x_left_bottom, y_left_bottom + 20)
        draw.line(
